...
class MainActivity : AppCompatActivity() {
    ...
    private var updateIntervalMillis = 15 * 60 * 1000L
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAvviaServizio.setOnClickListener {
            if (hasLocationPermission()) {
                startService(Intent(this, LocationService::class.java))
                Toast.makeText(this, "Servizio avviato", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this, "Richiedi i permessi prima", Toast.LENGTH_SHORT).show()
            }
        }

        binding.btnStoppaServizio.setOnClickListener {
            stopService(Intent(this, LocationService::class.java))
            Toast.makeText(this, "Servizio fermato", Toast.LENGTH_SHORT).show()
        }
